...
int *V_visitato;        // indica se un nodo è stato visitato (per DFS)
...
void find_best(tree_node_t *node)
{
    ...
    else
    {
        ...
        val_index = (float)visited_nodes*visited_nodes / total_distance;
