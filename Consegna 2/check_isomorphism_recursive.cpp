...
bool Isomorphism_rec(node* n1, node* n2) {
    ...
    if(n1 != NULL && n2 != NULL) {
        return
        (Isomorphism_rec(n1->L, n2->L) && Isomorphism_rec(n1->R, n2->R) ||
         Isomorphism_rec(n1->L, n2->R) && Isomorphism_rec(n1->R, n2->L));
    }
}
...
int main(int argc, char** argv) {
    ...
    string equal = Isomorphism_rec(n1, n2) ? "isomorphism found" : "isomorphism NOT found";
    cout << equal << endl;;
}